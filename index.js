...
const {editTaskMenu, proceedTaskEdit, targetDescriptionQuestion, descriptionQuestion, descriptionEdit } = require("./commands/edit_task");
  ...
  try {
    ...
    switch (action) {
      ...
      case "skip_edit_description_name":
       await targetDescriptionQuestion(ctx);
        break;
